...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default='',
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='/home/ms/wtc/SS-HOI/models/ctdet_coco_dla_2x.pth',
    ...
    self.parser.add_argument('--lr_step', type=str, default='40',
    ...
    self.parser.add_argument('--hm_act_weight', type=float, default=1,
                             help='loss weight for action heatmaps.')
    ...
    self.parser.add_argument('--not_act_hm', action='store_true',
                             help='not predict action.')
  ...
  def parse(self, args=''):
    ...
    opt.data_dir = os.path.join('/home/wangtiancai/', 'data')
    # opt.exp_dir = os.path.join(opt.root_dir, 'exp', opt.task)
    # opt.save_dir_pre = os.path.join(opt.exp_dir, opt.exp_id)
    opt.save_dir = os.path.join(opt.root_dir, '/data/weights/ACT-UNION-VCOCO-CORERPOOL/ft_from_coco/')
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    opt.num_obj_classes = dataset.num_obj_classes
    opt.num_act_classes = dataset.num_act_classes
    ...
    if opt.task == 'ctdet':
        opt.heads = {'hm_act_f': opt.num_act_classes, 'wh_act':2}
    else:
  ...
  def init(self, args=''):
    ...
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_obj_classes': 80, 'num_act_classes': 29,
